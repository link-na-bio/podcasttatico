...
// 5. Remove srcset and sizes and loading="lazy" and decoding="async" from ALL images
...
// Ah! Let me fix the slashes by just using string split and join or correct Regex strings.
// Wait, I am using string literals inside a JS file, so I don't need to overscape if I just use regex literals.
html = html.replace(/\\s*srcset="[^"]*"/g, '');
// Wait, actually I will just write a new assignment:

html = html.replace(/\\s*srcset="[^"]*"/gi, ''); // Still backslashes! Let's just use regular JS regexes.
